...
class AppException(Exception):
    """
    Base application exception class for representing application errors

    All errors in this application should inherit from this class.
...
class ApiException(AppException):
    ...
    All errors returned to clients in this application should inherit from this class. Errors are structured according
    to the JSON API specification, https://jsonapi.org/format/#error-objects.
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(code=code, title=title, detail=detail, meta=meta)
