...
class CategorySchemesResourceTestCase(BaseResourceTestCase):
    def test_category_scheme_list(self):
        expected_payload = {
            ...
            "links": {
                "first": "http://localhost:9001/category-schemes?page=1",
                "last": "http://localhost:9001/category-schemes?page=2",
                "next": "http://localhost:9001/category-schemes?page=2",
                "prev": None,
                "self": "http://localhost:9001/category-schemes?page=1"
            }
        }
    ...
    def test_category_scheme_category_terms(self):
        expected_payload = {
            ...
            "links": {
                "self": "http://localhost:9001/category-schemes/01DC6HYAKXG8FCN63D7DH06W84/categories"
            }
        }
