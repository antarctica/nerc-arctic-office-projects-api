...
def test_app_exception_initialization():
    ...
    exc_json = exc.json()
    assert (
        exc_json == '{"title": "Test Title", "code": "TEST_CODE", "detail": "Test Detail", "meta": {"info": "test"}}'
    )
...
def app():
    ...
    app.register_error_handler(
        HTTPStatus.BAD_REQUEST, error_handler_generic_bad_request
    )
    app.register_error_handler(
        HTTPStatus.INTERNAL_SERVER_ERROR, error_handler_generic_internal_server_error
    )
    app.register_error_handler(HTTPStatus.NOT_FOUND, error_handler_generic_not_found)
    app.register_error_handler(
        HTTPStatus.UNPROCESSABLE_ENTITY, error_handler_generic_unprocessable_entity
    )
    ...
    app.register_error_handler(
        ApiInternalServerError, error_handler_generic_internal_server_error
    )
    app.register_error_handler(ApiNotFoundError, error_handler_generic_not_found)
    app.register_error_handler(
        ApiUnprocessableEntityError, error_handler_generic_unprocessable_entity
    )
